...
namespace WDBXLib.Extensions
{
    public static class Extensions
    {
        ...
        public static T GetAttribute<T>(this PropertyInfo field) where T : Attribute
        {
            return field.GetCustomAttribute(typeof(T), false) as T;
        }
    }
}
